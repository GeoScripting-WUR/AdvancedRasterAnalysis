...
Give it a try and see here for some more information on the syntax how the write a documented report.
https://support.rstudio.com/hc/en-us/articles/200552086-Using-R-Markdown

If is possible that you obtain the following error on Windows Operation system:
...
E-mail (Ben and Jan) a link to the published documented report (html) to RPubs (as described above) together with the link to your project GitHub repository for this assigment.
