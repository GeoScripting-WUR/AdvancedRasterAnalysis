...
download.file(url = 'https://github.com/GeoScripting-WUR/AdvancedRasterAnalysis/raw/gh-pages/data/data.zip', destfile ='data.zip', method = 'auto')
...
# Excercise 09 : Advanced Raster Analysis
